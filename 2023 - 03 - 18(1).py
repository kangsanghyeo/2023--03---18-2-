...
for page in range(10): 
      url = 'https://comic.naver.com/webtoon/detail?titleId=648419&no={0}'.format(page)
      ...
      for i in range(count1):
            ...
            for page2 in 
            url = 'https://comic.naver.com/webtoon/detail?titleId=648419&no=2'
            site = requests.get(url, headers=headers)
            ...
            for u in range(count2):
                  ...
                  print(u+1, c_data)
                  try:
                        file_name = './webtoon2/{0}{1}{2}.{3}'.format('뷰티풀 군바리', b_data, u+1, c_data[-3:])
